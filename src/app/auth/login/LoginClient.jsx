...
function LoginForm({ user }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If signIn returns ok, it succeeded
      if (result?.ok) {
      ...
      if (result?.error) {
        ...
        if (errorMsg.includes("User not found") || errorMsg.includes("Invalid email or password") || errorMsg.includes("Callback")) {
        ...
        // signIn might return a string URL on redirect
        ...
        // Fallback: check if we were redirected to error page
    ...
    <main className="min-h-screen bg-[#05050a] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500">Sign in to your SkillEval account</p>
        </div>
